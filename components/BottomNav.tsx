        ...
        <nav className="flex justify-around items-center h-20">
          ...
          <div className="w-20 flex justify-center -mt-8">
            <button
                ...
                className="w-16 h-16 bg-white rounded-full shadow-lg shadow-cyan-500/30 flex items-center justify-center text-gray-900 hover:bg-gray-200 transition-all duration-300 active:scale-95 border-4 border-[#0C0C0E]"
