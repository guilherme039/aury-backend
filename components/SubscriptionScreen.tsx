    ...
    return (
        <div className="bg-[#0C0C0E] min-h-screen font-sans text-[#E5E7EB] antialiased body-bg-animate flex flex-col p-6 relative">
            ...
            {onBypass && (
                <button 
                    onClick={onBypass}
                    className="fixed bottom-6 left-6 w-10 h-10 bg-yellow-400 text-black rounded-full flex items-center justify-center shadow-lg hover:bg-yellow-300 transition-colors z-50 opacity-80 hover:opacity-100"
                    aria-label="Dev Unlock"
                    title="Desbloqueio de Desenvolvedor"
                >
